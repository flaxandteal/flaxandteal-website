...
sections:
  - type: hero_products
    ...
    text: "*Supporting R&D-driven organisations to scale simulation, modernise scientific software, and productise complex models – without losing trust in the physics.*"
  - type: product-text
    order: 1
    heading: "Who we are"
    bg_color: "#334B4E"
  - type: product-text
    order: 2
    heading: "Where we typically help"
    bg_color: "#292929"
  - type: product-text
    order: 3
